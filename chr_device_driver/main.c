...
ssize_t my_read(struct file *filp, char __user *buff, size_t count, loff_t *lfpos){
	pr_info("Reading...\n");
	return 0;
}

ssize_t my_write(struct file *filp, const char __user *buff, size_t count, loff_t *lfpos){
	pr_info("Writing...\n");
	return 0;
}
